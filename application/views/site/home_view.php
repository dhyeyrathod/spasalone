                ...
                <div class="col-md-12">
                    <div class="header-slider">
                        <div class="header-single-slider">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/sliders/slider01.jpg" alt="">
                                <figcaption>
                                    <div class="content">
                                        <div class="container inner-content text-left">
                                            ...
                                            <a href="<?= base_url('contact') ?>" class="boxed-btn">Make an Appoinment</a>
                                        </div>
                                    </div>
                                </figcaption>
                            </figure>
                        ...
                        <div class="header-single-slider">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/sliders/slider02.jpg" alt="">
                                <figcaption>
                                    <div class="content">
                        ...
                        <div class="header-single-slider">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/sliders/slider03.jpg" alt="">
                                <figcaption>
                                    <div class="content">
            ...
            <div class="container contact-wrapper text-center text-xl-left">
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-6 single-contact">
                        <img src="<?= base_url() ?>/assets/img/icons/icon01.png" alt="">
                        <h4>Opening Time</h4>
                        <p>Mon - Sat: 10h00 - 18h00</p>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-6 single-contact">
                        <img src="<?= base_url() ?>/assets/img/icons/icon02.png" alt="">
                        <h4>Address</h4>
                        <p>40 Baria Sreet, NY USAm</p>
                    </div>
                    <div class="col-xl-4 offset-xl-0 col-md-6 col-sm-6 offset-sm-3 single-contact">
                        <img src="<?= base_url() ?>/assets/img/icons/icon03.png" alt="">
                        <h4>Telephone</h4>
                        <p>+12 345 678 9101</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                        <div class="service-box text-center">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/service/service01.png" alt="">
                                <figcaption>
                                    <div class="inner-text">
                                        <a href="<?= base_url('services') ?>" class="boxed-btn">Book now</a>
                                    </div>
                                </figcaption>
                            </figure>
                            <h4>Oil Massage</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                        <div class="service-box text-center">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/service/service02.png" alt="">
                                <figcaption>
                                    <div class="inner-text">
                                        <a href="<?= base_url('services') ?>" class="boxed-btn">Book now</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-sm-0">
                        <div class="service-box text-center">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/service/service03.png" alt="">
                                <figcaption>
                                    <div class="inner-text">
                                        <a href="<?= base_url('services') ?>" class="boxed-btn">Book now</a>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="service-box text-center">
                            <figure>
                                <img src="<?= base_url() ?>/assets/img/service/service04.png" alt="">
                                <figcaption>
                                    <div class="inner-text">
                                        <a href="<?= base_url('services') ?>" class="boxed-btn">Book now</a>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                            <div id="hair" class="tab-pane">
                                <ul>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio01.png" alt="">
                                        <a href="#">
                                            <h4>Massage <span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio02.png" alt="">
                                        <a href="#">
                                            <h4>Massage Lavender <span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                </ul>
                            ...
                            <div id="makeup" class="tab-pane">
                                <ul>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio01.png" alt="">
                                        <a href="#">
                                            <h4>Massage Stone<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio05.png" alt="">
                                        <a href="#">
                                            <h4>Massage Relax<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio04.png" alt="">
                                        <a href="#">
                                            <h4>Massage Water<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                </ul>
                            ...
                            <div id="massage" class="tab-pane fade-in active">
                                <ul>
                                    ...
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio05.png" alt="">
                                        <a href="#">
                                            <h4>Massage Stone <span class="price">$28.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio02.png" alt="">
                                        <a href="#">
                                            <h4>Massage Stone & Steam <span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio06.png" alt="">
                                        <a href="#">
                                            <h4>Massage relax <span class="price">$34.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio03.png" alt="">
                                        <a href="#">
                                            <h4>Massage Lavender <span class="price">$35.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio07.png" alt="">
                                        <a href="#">
                                            <h4>Massage & Hot water <span class="price">$8.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio04.png" alt="">
                                        <a href="#">
                                            <h4>Massage Full Body <span class="price">$40.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio08.png" alt="">
                                        <a href="#">
                                            <h4>Massage Full Combo <span class="price">$102.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                </ul>
                            ...
                            <div id="nail" class="tab-pane">
                                <ul>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio07.png" alt="">
                                        <a href="#">
                                            <h4>Massage Oil<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                            ...
                            <div id="waxing" class="tab-pane">
                                <ul>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio08.png" alt="">
                                        <a href="#">
                                            <h4>Massage Candle<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                    <li>
                                        <img src="<?= base_url() ?>/assets/img/portfolio/portfolio04.png" alt="">
                                        <a href="#">
                                            <h4>Massage Pani<span class="price">$24.95</span></h4>
                                        </a>
                                        <p>Oil, candle, stone, water,...</p>
                                    </li>
                                </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                        <div class="feature-box text-center">
                            <div class="feature-icon">
                                <img src="<?= base_url() ?>/assets/img/feature-icon/feature-icon01.png" alt="">
                            </div>
                            <h4>Hair Expert</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                        <div class="feature-box text-center">
                            <div class="feature-icon">
                                <img src="<?= base_url() ?>/assets/img/feature-icon/feature-icon02.png" alt="">
                            </div>
                            <h4>Stone Massage</h4>
                            <p>Lorem Ipsum is simply dummy text  the printing and typesetting.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-sm-0">
                        <div class="feature-box text-center">
                            <div class="feature-icon">
                                <img src="<?= base_url() ?>/assets/img/feature-icon/feature-icon03.png" alt="">
                            </div>
                            <h4>Nail Care</h4>
                            <p>Lorem Ipsum is simply dummy text  the printing and typesetting.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="feature-box text-center">
                            <div class="feature-icon">
                                <img src="<?= base_url() ?>/assets/img/feature-icon/feature-icon04.png" alt="">
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                        <div class="pricing-box text-center" style="background: url(assets/img/pricing/pricing01.jpg) no-repeat center / cover;">
                            <h3>Silver Pack</h3>
                            <hr>
                    ...
                    <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                        <div class="pricing-box recomended text-center" style="background: url(assets/img/pricing/pricing02.jpg) no-repeat center / cover;">
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="pricing-box text-center" style="background: url(assets/img/pricing/pricing03.jpg) no-repeat center / cover;">
                            <h3>Platinum Pack</h3>
                            <hr>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 single-box mb-5 mb-lg-0">
                        <img src="<?= base_url() ?>/assets/img/counter/counter-icon01.png" alt="">
                        <h3><span class="counter">870</span></h3>
                        <p>Win Awards</p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 single-box mb-5 mb-lg-0">
                        <img src="<?= base_url() ?>/assets/img/counter/counter-icon02.png" alt="">
                        <h3><span class="counter">1523</span></h3>
                        <p>Happy Clients</p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 single-box mb-5 mb-sm-0">
                        <img src="<?= base_url() ?>/assets/img/counter/counter-icon03.png" alt="">
                        <h3><span class="counter">100</span></h3>
                        <p>Treatments</p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 single-box">
                        <img src="<?= base_url() ?>/assets/img/counter/counter-icon04.png" alt="">
                        ...
                        <div class="product-carousel">
                            <div class="single-product text-center">
                                ...
                                <div class="product-img">
                                    <img src="<?= base_url() ?>/assets/img/product/product01.png" alt="">
                                </div>
                                <ul class="rate">
                                ...
                                <div class="overlay">
                                    <ul class="icons">
                                        ...
                                        <li><a href="<?= base_url() ?>/assets/img/product/product01.png" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="single-product text-center">
                                <div class="product-img">
                                    <img src="<?= base_url() ?>/assets/img/product/product02.png" alt="">
                                </div>
                                <ul class="rate">
                                    <li><i class="fas fa-star"></i></li>
                                    <li><i class="fas fa-star"></i></li>
                                ...
                                <div class="overlay">
                                    <ul class="icons">
                                        <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                        <li><a href="<?= base_url() ?>/assets/img/product/product02.png" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="single-product text-center">
                                <span class="sale">Sale!</span>
                                <div class="product-img">
                                    <img src="<?= base_url() ?>/assets/img/product/product03.png" alt="">
                                </div>
                                <ul class="rate">
                                    <li><i class="fas fa-star"></i></li>
                                    <li><i class="fas fa-star"></i></li>
                                ...
                                <div class="overlay">
                                    <ul class="icons">
                                        <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                        <li><a href="<?= base_url() ?>/assets/img/product/product03.png" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="single-product text-center">
                                <div class="product-img">
                                    <img src="<?= base_url() ?>/assets/img/product/product04.png" alt="">
                                </div>
                                <ul class="rate">
                                    <li><i class="fas fa-star"></i></li>
                                    <li><i class="fas fa-star"></i></li>
                                ...
                                <div class="overlay">
                                    <ul class="icons">
                                        <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                        <li><a href="<?= base_url() ?>/assets/img/product/product04.png" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-lg-0">
                        <div class="single-beauticians">
                            <div class="img-wrapper">
                                <img src="<?= base_url() ?>/assets/img/beauticians/beauticians01.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-lg-0">
                        <div class="single-beauticians">
                            <div class="img-wrapper">
                                <img src="<?= base_url() ?>/assets/img/beauticians/beauticians02.jpg" alt="">
                                <div class="beautician-footer-text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-sm-0">
                        <div class="single-beauticians">
                            <div class="img-wrapper">
                                <img src="<?= base_url() ?>/assets/img/beauticians/beauticians03.jpg" alt="">
                                <div class="beautician-footer-text">
                                    <h5>Eric Matision</h5>
                                    <p>Skin Expert</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-beauticians">
                            <div class="img-wrapper">
                                <img src="<?= base_url() ?>/assets/img/beauticians/beauticians04.jpg" alt="">
                                <div class="beautician-footer-text">
                                    <h5>Betty Ross</h5>
                                    <p>Massagist</p>
                                </div>
                        ...
                        <div class="partner-carousel">
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-1.png" alt="">
                                </div>
                            </div>
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-2.png" alt="">
                                </div>
                            </div>
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-3.png" alt="">
                                </div>
                            </div>
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-4.png" alt="">
                                </div>
                            </div>
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-5.png" alt="">
                                </div>
                            </div>
                            <div class="single-partner">
                                <div class="inner-partner">
                                    <img src="<?= base_url() ?>/assets/img/partners/partner-6.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
